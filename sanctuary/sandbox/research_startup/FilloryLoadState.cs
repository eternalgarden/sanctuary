...
/// <summary>
/// The single [HasState] snapshot of "how far through startup are we".
/// It retains its last value and replays it to any late subscriber, which is
/// what lets subsystems wire up in any order and still see the current state.
/// Exactly one long-lived writer is allowed (the reducer in StartupProcess).
/// </summary>
[HasState]
